...
GameStore.Categories = {
	...
	-- Nemesis Shop
	{
		...
		name = "Nemesis Exclusive",
		rookgaard = true,
		subclasses = { "Hot Offers", "Char Lover", "Exclusive Offers" },
	},
	-- Nemesis Hot Offers
	{
		...
		offers = {
			...
			},
			{
				...
				itemtype = 39546,
				count = 1,
				description = "A small gift from the gnomes of gnomprona.\nIt weighs 160.00 oz.\nImportante: Esse item de forma alguma se caracteriza como lootbox, todos os itens a seguir tem a mesma chance de dropar:\nAlicorn Headguard\nAlicorn Quiver\nAlicorn Ring\nArboreal Crown\nArboreal Ring\nArboreal Tome\nArcanomancer Folio\nArcanomancer Regalia\nArcanomancer Sigil\nSpiritthorn Armor\nSpiritthorn Helmet\nSpiritthorn Ring\n{capacity}",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true,
			},
			{
	...
	-- Other Offers
	{
		...
		offers = {
			{
				icons = { "adventurer_doll.png" },
				name = "Little Adventurer Doll",
				price = 200,
				itemtype = 22120,
				count = 1,
				description = "This little fellow has faced many dangers. He will follow you anywhere.\n{capacity}",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true,
			},
			{
				icons = { "dark_wizards_crown.png" },
				name = "Dark Wizard's Crown",
				price = 200,
				itemtype = 22153,
				count = 1,
				description = "It grants infinite power and knowledge to the one who wears it.\n{capacity}",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true,
			},
			{
				...
				itemtype = 12043,
				count = 1,
				description = "This doll seems to be the favourite doll of the emperor.\n{capacity}",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true,
			},
			{
				icons = { "draptor_doll.png" },
				name = "Draptor Doll",
				price = 200,
				itemtype = 37743,
				count = 1,
				description = "Only the chosen ones have withnessed this extremely rare phenomenon of draptors transformation.\n{capacity}",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true,
			},
			{
				...
				itemtype = 37750,
				count = 1,
				description = "Rumours say that someone took the skull of Goshnar from his grave to create this scary magical device.\n{capacity}",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true,
			},
			{
				...
				itemtype = 37061,
				count = 1,
				description = "Omnipotent energies inhabit this place. It is my mission to protect our home.\n{capacity}",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true,
			},
			{
			...
			{
				icons = { "ferumbras_puppet.png" },
				name = "Ferumbras Puppet",
				price = 200,
				itemtype = 30317,
				count = 1,
				description = "Will be your best friend to sad moments.\n{capacity}",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true,
			},
			{
				icons = { "journal_shield.png" },
				name = "Journal Shield",
				price = 200,
				itemtype = 26948,
				count = 1,
				description = "Tibia's very first headline is written on it.\n{capacity}",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true,
			},
			{
				...
				itemtype = 36996,
				count = 1,
				description = "Gently shrouded in clouds, her dreams are about to come true. As she awakens something magical is about to happen.\n{capacity}",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true,
			},
			{
				...
				itemtype = 36978,
				count = 1,
				description = "This hat represents the spirit of magic and fun.\n{capacity}",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true,
			},
			{
				icons = { "wicked_witch.png" },
				name = "Wicked Witch",
				price = 200,
				itemtype = 34326,
				count = 1,
				description = "She was one of Ferumbras former students at the Noodles Academy.\n{capacity}",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true,
			},
		},
		...
		offers = {
			{
				...
				itemtype = 36728,
				count = 1,
				description = "Faz com que as mortes para o Bestiario contem duas vezes, por uma hora. Item agrupavel.\n{capacity}",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				...
				itemtype = 36725,
				count = 1,
				description = "Enche uma hora de stamina, mas nao ultrapassa o limite maximo. Item agrupavel.\n{capacity}",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				...
				itemtype = 36724,
				count = 1,
				description = "Aumenta a chance de causar dano critico em 5% por uma hora. Item agrupavel.\n{capacity}",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				...
				itemtype = 36726,
				count = 1,
				description = "Aumenta as chances de acionar um charm ofensivo em 5% (exceto Cripple) por uma hora. Item agrupavel.\n{capacity}",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				...
				itemtype = 36727,
				count = 1,
				description = "Dobra o loot de todos os monstros normais mortos, por uma hora. Item agrupavel.\n{capacity}",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
		},
	},
