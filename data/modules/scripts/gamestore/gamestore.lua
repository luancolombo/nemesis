...
GameStore.Categories = {
	...
	-- Nemesis Shop
	{
		...
		rookgaard = true,
		subclasses = { "Hot Offers", "Promotion Scrools", "Exclusive Offers" },
	},
	-- Nemesis Hot Offers
	{
	...
	-- Promotion Scrools Offers
	{
		icons = { "Category_HouseUpgrades.png" },
		parent = "Nemesis Exclusive",
		name = "Promotion Scrools",
		rookgaard = true,
		offers = {
			{
				icons = { "abridged_promotion.png" },
				name = "Abridged Promotion Scroll",
				price = 6,
				itemtype = 43946,
				count = 1,
				description = "Only a hero of level 51 or above can decipher this scroll to gain 3 promotion points for the Wheel of Destiny\n{capacity}",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "basic_promotion.png" },
				name = "Basic Promotion Scroll",
				price = 10,
				itemtype = 43947,
				count = 1,
				description = "Only a hero of level 51 or above can decipher this scroll to gain 5 promotion points for the Wheel of Destiny\n{capacity}",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "revised_promotion.png" },
				name = "Revised Promotion Scroll",
				price = 18,
				itemtype = 43948,
				count = 1,
				description = "Only a hero of level 51 or above can decipher this scroll to gain 9 promotion points for the Wheel of Destiny\n{capacity}",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "extended_promotion.png" },
				name = "Extended Promotion Scroll",
				price = 26,
				itemtype = 43949,
				count = 1,
				description = "Only a hero of level 51 or above can decipher this scroll to gain 13 promotion points for the Wheel of Destiny\n{capacity}",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "advanced_promotion.png" },
